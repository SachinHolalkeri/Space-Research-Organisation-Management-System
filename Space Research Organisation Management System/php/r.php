...
if($total !=0)
{
    ...
    while($result= mysqli_fetch_assoc($data))
    {
        ...
        <td><a href='op.php?mi=$result[M_Id]&n=$result[Name]&bg=$result[Budget]&g=$result[Goal]&sd=$result[Startdate]&ci=$result[C_Id]&ny=$result[No_years]&vi=$result[V_Id]'>EDIT</a></td>
...
<form action="insert.php" method="post">
    ...
    <tr>
        ...
        <th><input type="number" name="M_Id" id="M_Id">
        </th></tr>
    <tr>
    ...
    <tr>
        ...
        <th><input type="datetime-local" name="Startdate" id="Startdate"></th>
    </tr>
    <tr>
